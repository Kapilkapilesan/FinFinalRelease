                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-gray-50/80 rounded-2xl p-4 border border-gray-100 space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <div className="text-xs font-black theme-text-primary">{(Number(selectedInv?.snapshot_interest_rate) * 100).toFixed(2)}% APR</div>
                                                </div>
                                                <div className="space-y-1">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <button
                                                ...
                                                disabled={isProcessing}
                                                className="w-full py-2.5 bg-white text-rose-500 border-2 border-rose-50 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-rose-50 active:scale-95 transition-all flex items-center justify-center gap-3"
                                            >
