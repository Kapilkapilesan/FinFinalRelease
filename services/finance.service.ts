...
export const financeService = {
    ...
    approveBranchRequest: async (id: number, note?: string): Promise<any> => {
    ...
    approveOtherBranchCollection: async (id: number, note?: string): Promise<any> => {
