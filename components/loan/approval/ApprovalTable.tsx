                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y divide-border-divider">
                        {loans.map((loan) => {
                            ...
                            return (
                                <tr key={loan.id} className={`hover:bg-table-row-hover transition-colors ${overdueWarning ? 'bg-primary-50/10 dark:bg-primary-500/5' : ''}`}>
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        {loan.firstApproval === 'Pending' && (
                                            <span className="px-2 py-1 bg-primary-500/10 text-primary-600 dark:text-primary-400 border border-primary-500/20 rounded text-[10px] font-bold uppercase tracking-wider">Pending</span>
                                        )}
