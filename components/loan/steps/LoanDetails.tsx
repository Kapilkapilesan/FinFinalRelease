                                ...
                                <div className="max-h-60 overflow-y-auto custom-scrollbar p-1.5">
                                    {loanProducts.map((product) => (
                                        <div
                                            ...
                                            className={`px-4 py-3 rounded-xl text-sm cursor-pointer transition-all mb-1 font-black ${String(formData.loanProduct) === String(product.id) ? 'bg-primary-500/10 text-primary-500 border border-primary-500/20' : 'hover:bg-muted-bg'}`}
                                        >
                                        ...
                                        <div className="max-h-60 overflow-y-auto custom-scrollbar p-1.5">
                                            {selectedProduct.product_terms.map((term, idx) => (
                                                <div
                                                    ...
                                                    className={`px-4 py-3 rounded-xl text-sm cursor-pointer transition-all mb-1 font-black ${String(formData.tenure) === String(Number(term.term) * getWeeksMultiplier(selectedProduct.term_type)) ? 'bg-primary-500/10 text-primary-500 border border-primary-500/20' : 'hover:bg-muted-bg text-text-primary'}`}
                                                >
