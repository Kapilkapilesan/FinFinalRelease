                                ...
                                <div className="max-h-60 overflow-y-auto custom-scrollbar p-1.5">
                                    {filteredProductsList.length > 0 ? (
                                        filteredProductsList.map((product) => (
                                            ...
                                            >
                                                <span className={`font-black tracking-tight ${String(formData.loanProduct) === String(product.id) ? 'text-primary-500' : 'text-text-primary'}`}>
                                    ...
                                    <div className="max-h-60 overflow-y-auto custom-scrollbar p-1.5">
                                        {filteredCustomersList.length > 0 ? (
                                            filteredCustomersList.map((customer) => (
                                                ...
                                                >
                                                    <span className={`font-black tracking-tight ${String(formData.customer) === String(customer.id) ? 'text-primary-500' : 'text-text-primary'}`}>
                    ...
                    >
                        ...
                        <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-y-2 gap-x-6">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm font-black tracking-tight text-text-primary">{selectedCustomerRecord.name}</p>
                            </div>
                            <div className="space-y-0.5">
                            ...
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm font-black tracking-tight text-text-primary capitalize">{selectedCustomerRecord.gender || 'N/A'} / {selectedCustomerRecord.age ?? 'N/A'} Yrs</p>
                            </div>
                            <div className="space-y-0.5">
                                    ...
                                    <div key={idx} className="p-3 bg-primary-500/5 dark:bg-muted-bg/5 border-2 border-border-divider/50 rounded-2xl space-y-2 shadow-inner relative overflow-hidden group/guarantor">
                                        ...
                                        <div className="space-y-3 relative z-10">
                                            <div className="space-y-0.5">
                                                ...
                                                <div className="px-3 py-1.5 bg-card border border-border-divider/50 rounded-lg text-xs font-black text-text-primary tracking-tight shadow-sm">
