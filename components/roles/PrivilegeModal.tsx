...
export function PrivilegeModal({ isOpen, onClose, onSave, editingPrivilege }: PrivilegeModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-[150] p-4 animate-in fade-in duration-300">
            <div className="bg-white  rounded-[2.5rem] max-w-lg w-full shadow-2xl border border-gray-200  flex flex-col transform transition-all scale-100">
                ...
                <div className="p-8 space-y-8">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-4 bg-gray-50  border border-gray-100  rounded-2xl focus:outline-none focus:ring-4 focus:ring-green-500/10 focus:border-green-500 transition-all font-bold text-gray-900  placeholder:text-gray-400 placeholder:font-normal"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full p-4 bg-gray-50  border border-gray-100  rounded-2xl focus:outline-none focus:ring-4 focus:ring-green-500/10 focus:border-green-500 transition-all font-bold text-gray-900  placeholder:text-gray-400 placeholder:font-normal resize-none"
                        />
                    </div>
                </div>

                {/* Footer */}
                <div className="p-8 border-t border-gray-100  flex items-center justify-end gap-3 bg-gray-50/50  backdrop-blur-xl rounded-b-[2.5rem]">
                    <button
                        onClick={onClose}
                        className="px-8 py-4 text-xs font-black text-gray-500  hover:bg-white  rounded-2xl transition-all uppercase tracking-widest active:scale-95"
                    >
                        Cancel
                    </button>
                    <button
