...
export function RoleModal({ isOpen, onClose, onSave, editingRole, privileges, allDefinitions, defaultModules, existingRoles }: RoleModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center z-[150] p-4 animate-in fade-in duration-300">
            <div className="bg-white  rounded-[2.5rem] max-w-6xl w-full shadow-2xl border border-gray-200  flex flex-col max-h-[95vh] overflow-hidden transform transition-all scale-100">

                {/* Header */}
                <div className="p-8 border-b border-gray-100  flex items-center justify-between bg-white/80  backdrop-blur-xl sticky top-0 z-20">
                ...
                {/* Content */}
                <div className="flex-1 overflow-y-auto p-8 md:p-10 space-y-12 scrollbar-thin scrollbar-thumb-gray-200 ">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 bg-gray-50  border border-gray-100  rounded-2xl focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all font-bold text-gray-900  text-sm disabled:opacity-50"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 bg-white  border border-gray-100  rounded-2xl focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all font-bold text-gray-900  text-sm"
                                />
                            </div>
                                ...
                                {isCustomLevel && (
                                    <div className="mt-4 animate-in slide-in-from-top-2 duration-300">
                                        <input
                                            ...
                                            className="w-full px-5 py-4 bg-blue-50/50  border border-blue-100  rounded-2xl focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all font-bold text-blue-900  text-sm"
                                        />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="flex items-center justify-between p-6 bg-blue-50/30  rounded-3xl border border-blue-100/50 ">
                                <div>
                                    <h4 className="text-sm font-black text-gray-900 ">Default Role</h4>
                                    <p className="text-[10px] text-gray-500  mt-1 uppercase tracking-wider font-bold">Assign automatically to new user accounts</p>
                                </div>
                                <button
                                    type="button"
                                    onClick={() => setIsDefault(!isDefault)}
                                    className={`w-14 h-8 rounded-full transition-all relative ${isDefault ? 'bg-blue-600' : 'bg-gray-200 '}`}
                                >
                            ...
                            <div className="flex items-center justify-between p-6 bg-gray-50/50  rounded-3xl border border-gray-100 ">
                                <div>
                                    <h4 className="text-sm font-black text-gray-900 ">Editable Status</h4>
                                    <p className="text-[10px] text-gray-500  mt-1 uppercase tracking-wider font-bold">Allow future modifications to this role structure</p>
                                </div>
                                <button
                                    type="button"
                                    onClick={() => setIsEditable(!isEditable)}
                                    className={`w-14 h-8 rounded-full transition-all relative ${isEditable ? 'bg-green-600' : 'bg-gray-200 '}`}
                                >
                    ...
                    <div className="space-y-4">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-6 py-5 bg-white  border border-gray-100  rounded-[2rem] focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all font-medium text-gray-700  text-sm leading-relaxed"
                        />
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2 bg-blue-50  px-4 py-2 rounded-full border border-blue-100/50 ">
                ...
                {/* Footer */}
                <div className="p-8 border-t border-gray-100  flex items-center justify-end gap-4 bg-gray-50/50  backdrop-blur-xl">
                    <button
                        onClick={onClose}
                        className="px-8 py-4 text-xs font-black text-gray-500  hover:bg-white  rounded-2xl transition-all uppercase tracking-widest shadow-sm active:scale-95"
                    >
                        Cancel
                    </button>
                    <button
