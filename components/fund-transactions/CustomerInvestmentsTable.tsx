                                        ...
                                        <div className="flex justify-center">
                                            {record.status === 'ACTIVE' && (
                                                <button
                                                    ...
                                                    className={`group relative flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-black text-[9px] uppercase tracking-widest transition-all active:scale-95 shadow-lg ${isPrinting === record.id ? 'bg-gray-100 text-gray-400 cursor-wait' : isPrintLocked ? (record.reprint_requested ? 'bg-blue-500 text-white shadow-blue-500/20 hover:bg-blue-600' : 'bg-amber-500 text-white shadow-amber-500/20 hover:bg-amber-600') : 'bg-primary-600 text-white shadow-primary-500/20 hover:bg-primary-700'}`}
                                                >
